...
LLAMA_FRAMEWORK_SOURCE="$REPO_DIR/Vendor/llama.xcframework/macos-arm64_x86_64/llama.framework"
...
"$REPO_DIR/scripts/bootstrap-llama.sh"
...
ditto "$LLAMA_FRAMEWORK_SOURCE" "$APP_DIR/Contents/Frameworks/llama.framework"
...
codesign --force --sign - "$APP_DIR/Contents/Frameworks/llama.framework"
